...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields=['id','category','vendor','title','slug','tag_list','detail','price','usd_price','product_ratings','image','product_file','tags','publish_status','product_imgs']
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        many =True
        model=models.Product
        fields=['id','category','vendor','title','slug','tag_list','detail','price','usd_price','product_ratings','product_imgs','demo_url','image','product_file','downloads','publish_status','tags']
...
class CategorySerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields=['id','title','cat_img','detail','total_downloads']
